...
//Make a Selection sort algorithm
//Make the Bubble sort algorithm
//Make the Insertion sort algorithm
//Make the Shell sort algorithm
//Make the Merge sort algorithm
//Make the Array sort algorithm
//Make the Quick sort algorithm
...
public class Algorithms {
    public static void main(String[] args) {
        ...
        //Different algorithm that are implemented in the code below
        ...
        //   int[] quickSorting = quickSort(array,low,high);
        //   System.out.println(Arrays.toString(quickSorting));
